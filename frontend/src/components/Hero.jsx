...
// Add hero image to the hero section
const Hero = () => {
  return (
    <section className="max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[667px] w-full mb-10 relative">
      <div className='bg-white p-3 rounded-2xl max-w-[223px] relative top-8 xl:top-12'>
        ...
        <p className='text-[13px]'><b className='uppercase'>Step</b> into Style, One Pair at a Time. Find Your Perfect Fit—shop today!</p>
      </div>
