        ...
        <div className='min-w-72 bg-primary p-4 pt-8 pl-6 lg:pl-12 rounded-r-xl'>
          ...
          <div className='pl-5 py-3 mt-4 bg-white rounded-xl'>
            ...
            <div className='flex flex-col gap-2 text-sm font-light'>
              {["Men", "Women"].map((cat) => (
                <label key={cat} className='flex items-center gap-2 medium-14 text-gray-30'>
                  <input
          ...
          <div className='pl-5 py-3 mt-6 bg-white rounded-xl'>
            ...
            <div className='flex flex-col gap-2 text-sm font-light'>
              {["Sneakers", "Sports", "Loafers", "Boots", "Slippers"].map((subCat) => (
                <label key={subCat} className='flex items-center gap-2 medium-14 text-gray-30'>
                  <input
          ...
          <div className='px-4 py-3 mt-6 bg-white rounded-xl'>
            ...
            className='border border-slate-900/50 outline-none text-gray-30 medium-14 h-8 w-full rounded px-2'>
          ...
          <div className='bg-primary p-4 rounded-l-xl'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-5 gap-y-6'>
